...
![GitHub release](https://img.shields.io/github/release/wahub3000/gulp-scss-starter.svg)
[![dependencies Status](https://david-dm.org/wahub3000/gulp-scss-starter/status.svg)](https://david-dm.org/wahub3000/gulp-scss-starter)
[![devDependencies Status](https://david-dm.org/wahub3000/gulp-scss-starter/dev-status.svg)](https://david-dm.org/wahub3000/gulp-scss-starter?type=dev)
![GitHub stars](https://img.shields.io/github/stars/wahub3000/gulp-scss-starter.svg?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/wahub3000/gulp-scss-starter.svg?style=social)
...
* установите [NodeJS](https://nodejs.org/dist/v12.18.0/node-v12.18.0-x64.msi) (если требуется) и [Yarn](https://yarnpkg.com/en/docs/install)
* скачайте сборку с помощью [Git](https://git-scm.com/downloads): ```git clone https://github.com/wahub3000/gulp-scss-starter.git```
